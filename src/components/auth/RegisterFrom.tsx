...
const RegisterForm = () => {
  ...
  const userType = searchParams.get("type"); // Get the "type" from URL
  ...
  const onSubmit = async (data: RegisterFormData) => {
    // If user is driver and we're not on the final step, just move to next step
    if (userType === "driver" && currentStep === 1) {
      setCurrentStep(2);
      return;
    }
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <Button
                  type="button"
                  onClick={
                    currentStep === 4 ? handleSubmit(onSubmit) : handleNext
                  }
